...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdBrands).HasName("PK__Brands__147C88F56CAAA719");
        ...
        {
            entity.HasKey(e => e.IdCart).HasName("PK__Cart__7017949039AD57DE");
        ...
        {
            entity.HasKey(e => e.IdCatalogproducts).HasName("PK__CatalogP__7D82B6FAFC7884C7");
        ...
        {
            entity.HasKey(e => e.IdCategories).HasName("PK__Categori__487EC27551FEC65A");
        ...
        {
            entity.HasKey(e => e.IdReview).HasName("PK__Review__4D295FF84F3C84C6");
            ...
            entity.HasOne(d => d.Catalogroduct).WithMany(p => p.Reviews)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Review__Catalogr__5CD6CB2B");

            entity.HasOne(d => d.Users).WithMany(p => p.Reviews)
                .HasForeignKey(d => d.UsersId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Review__Users_ID__5DCAEF64");
        });

        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasKey(e => e.IdRole).HasName("PK__Roles__45DFFBDB7F9FC41D");
        ...
        {
            entity.HasKey(e => e.IdUsers).HasName("PK__Users__1806910418CDA685");

            entity.HasIndex(e => e.PhoneNumber, "UQ__Users__85FB4E38800727F9").IsUnique();

            entity.HasIndex(e => e.Loginvhod, "UQ__Users__89F837A0C395A390").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105342016A551").IsUnique();
